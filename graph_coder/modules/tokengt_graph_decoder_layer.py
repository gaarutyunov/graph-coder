...
class TokenGTGraphDecoderLayer(nn.Module):
    def __init__(
        self,
        ...
        # Initialize blocks
        self.self_attn_1 = self.build_self_attention(
            self.embedding_dim,
            num_attention_heads,
            performer=performer,
        ...
        self.self_attn_2 = self.build_self_attention(
            self.embedding_dim,
            num_attention_heads,
            performer=performer,
            performer_nb_features=performer_nb_features,
