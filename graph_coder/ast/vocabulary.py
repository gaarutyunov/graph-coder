...
class Vocabulary:
    counter: int = 2
    key_value: typing.Dict[int, str] = field(
        default_factory=lambda: {0: "[PAD]", 1: "[EMP]"}
    )
    value_key: typing.Dict[str, int] = field(
        default_factory=lambda: {"[EMP]": 1, "[PAD]": 0}
    )
    value_types: typing.Dict[int, str] = field(
        default_factory=lambda: {0: "special", 1: "special"}
    )
